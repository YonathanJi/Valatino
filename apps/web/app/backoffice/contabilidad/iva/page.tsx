...
// `Percent` y no `Calculator`: el icono de la calculadora es el del módulo
// Contabilidad en el sidebar, y repetirlo en la cabecera de un submódulo haría
// pensar que se está en la raíz del módulo. Mismo criterio que Proveedores, que
// usa su propio icono y no el de Compras.
...
export default function LiquidacionIvaPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      {/* Sin enlace «volver a Contabilidad», y a propósito: el padre
          (/backoffice/contabilidad) redirige AQUÍ, así que sería un bucle. Es la
          misma razón por la que los submódulos de TI tampoco lo llevan.
          Proveedores sí lo tiene porque Compras es una pantalla de verdad. */}
      <PageHeader
        icon={Percent}
